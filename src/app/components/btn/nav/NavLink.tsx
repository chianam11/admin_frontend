...
import { dataNavLeft } from './data/navTop';
const NavLink = () => {
    console.log(dataNavLeft);

    return (
        <div className="flex flex-col flex-1 pt-5 pb-4  max-w-64 overflow-y-scroll">
                ...
                <ul className="pb-2 space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-layouts" className="py-2 space-y-2 hidden">
                            <li>
                                <Link href="/" className="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                                >
                                    Stacked
                                </Link>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-crud" className="space-y-2 py-2 hidden ">
                            <li>
                                <Link href="/" className="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 "
                                >
                                    Products
                                </Link>
                            </li>
